// ABOUTME: Dedicated page for viewing live MediaMTX streams
// ABOUTME: Full page layout for stream monitoring
    ...
    <div className="min-h-screen">
      ...
      <main className="container mx-auto px-6 py-12">
        <div className="mb-8">
          ...
          <p className="text-gray-400">Monitor active MediaMTX streams and channels in real-time</p>
        </div>
